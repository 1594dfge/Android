package com.example.noiserecorder;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void button_Start(View v){
        ...
        mediaRecorder.setOutputFormat(MediaRecorder.OutputFormat.THREE_GPP); //設置輸出格式(.3gp)
        mediaRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB); //設置編碼方式
